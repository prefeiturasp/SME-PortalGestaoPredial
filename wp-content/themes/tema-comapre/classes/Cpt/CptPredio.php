...
class CptPredio extends Cpt
{
	...
	public function register()
	{
		...
		$labels = array(
			...
			'add_new' => _x('Cadastrar predio administrativa ', 'Nova Predio'),
			'add_new_item' => __('Nova Predio'),
			'edit_item' => __('Editar Predio'),
			'new_item' => __('Nova Predio'),
			'view_item' => __('Ver Item'),
			'search_items' => __('Procurar Predios'),
			'not_found' => __('Nenhuma predio encontrada'),
			'not_found_in_trash' => __('Nenhum predio encontrada na lixeira'),
			'parent_item_colon' => '',
			'menu_name' => $this->name
		);

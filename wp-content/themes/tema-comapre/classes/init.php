...
require_once 'Cpt/CptPredio.php';
require_once 'Cpt/CptDestaque.php';
include_once 'acf-insta-predi/init.php';
require_once 'acf-exc-insta-predi/init.php';
require_once 'acf-ambientes/init.php';
...
$cptPredios = new \Classes\Cpt\Cpt('predio', 'predio', 'Instalação Predial', 'Minhas Instalações', 'Instalações', 'Cadastro de Instalações', '', '', '', 'dashicons-building' , true);
$cptPrediosExtend = new \Classes\Cpt\CptPredio();

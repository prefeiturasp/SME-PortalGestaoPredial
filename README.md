...
docker build -t registry.sme.prefeitura.sp.gov.br/wordpress/{nome-repositorio}/gestpred .

docker push registry.sme.prefeitura.sp.gov.br/wordpress/base:7.4.33-apache-bullseye

docker push registry.sme.prefeitura.sp.gov.br/wordpress/{nome-repositorio}/gestpred
